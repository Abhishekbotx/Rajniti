export default function Home() {
  return (
    <div className="min-h-screen bg-gradient-to-b from-orange-50 via-white to-green-50">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="flex h-16 items-center justify-between">
            <div className="flex items-center gap-2">
              ...
              <span className="text-xl font-bold text-gray-900">Rajniti</span>
            </div>
            <nav className="hidden md:flex gap-6">
              <a href="#about" className="text-gray-600 hover:text-orange-600 transition-colors">About</a>
              <a href="#contribute" className="text-gray-600 hover:text-orange-600 transition-colors">Contribute</a>
              <a href="#api" className="text-gray-600 hover:text-orange-600 transition-colors">API</a>
            </nav>
          </div>
        </div>
      </header>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="mx-auto max-w-2xl text-lg sm:text-xl text-gray-600 mb-10">
              Rajniti is a clean, lightweight REST API providing comprehensive Indian Election Commission data. 
              Access 50,000+ records across Lok Sabha and Assembly elections - free and open source.
            </p>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              Democracy thrives on transparency and accessibility. We&apos;re building a platform to make Indian election data 
              freely available to citizens, researchers, and developers.
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-3 gap-8">
            <div className="bg-gradient-to-br from-orange-50 to-orange-100 rounded-2xl p-8 border border-orange-200">
              ...
              <p className="text-gray-600">
                50,000+ records covering Lok Sabha and Assembly elections with detailed candidate, party, and constituency information.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-white to-gray-50 rounded-2xl p-8 border border-gray-200">
              ...
              <p className="text-gray-600">
                Clean REST API with minimal setup. No complex authentication - just straightforward data access for everyone.
              </p>
            </div>
            ...
            <div className="bg-gradient-to-br from-green-50 to-green-100 rounded-2xl p-8 border border-green-200">
              ...
              <p className="text-gray-600">
                MIT licensed and community-driven. Built by the people, for the people. Your contributions make democracy more accessible.
              </p>
            </div>
          </div>
        </div>
      ...
      {/* Contribute Section */}
      <section id="contribute" className="py-20 bg-gradient-to-r from-orange-600 to-orange-500 text-white">
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-orange-100 max-w-3xl mx-auto">
              Rajniti is built by contributors who believe in accessible democracy. Whether you&apos;re a developer, 
              researcher, or democracy enthusiast - there&apos;s a place for you!
            </p>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              ...
              <p className="text-orange-100 mb-4">
                Help improve the API, add features, fix bugs, or enhance our data scraping capabilities.
              </p>
              <a 
            ...
            <div className="bg-white/10 backdrop-blur-sm rounded-xl p-6 border border-white/20">
              <div className="text-3xl mb-3">📚</div>
              <h3 className="text-xl font-bold mb-2">Improve Documentation</h3>
              <p className="text-orange-100 mb-4">
                Help make Rajniti more accessible by improving guides, adding examples, or translating docs.
              </p>
              <a 
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            <div className="inline-flex items-center gap-2 rounded-full bg-yellow-100 px-4 py-2 mb-6">
              ...
              <span className="text-sm font-semibold text-yellow-800">Coming Soon</span>
            </div>
            <h2 className="text-3xl sm:text-4xl font-bold text-gray-900 mb-4">
              Public API Platform
            </h2>
            <p className="text-lg text-gray-600 max-w-3xl mx-auto">
              We&apos;re building a comprehensive API platform that will serve election data to frontend applications, 
              analytics tools, and the Saransh app. Stay tuned for updates!
            </p>
          </div>
          ...
          <div className="max-w-3xl mx-auto bg-white rounded-2xl shadow-lg border border-gray-200 p-8">
            <div className="space-y-6">
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">RESTful API Endpoints</h4>
                  <p className="text-gray-600 text-sm">
                    Clean, intuitive endpoints for elections, candidates, parties, and constituencies.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  ...
                  <p className="text-gray-600 text-sm">
                    Access up-to-date election results and candidate information as they become available.
                  </p>
                </div>
              </div>
              ...
              <div className="flex items-start gap-4">
                ...
                <div>
                  <h4 className="font-semibold text-gray-900 mb-1">Developer-Friendly Documentation</h4>
                  <p className="text-gray-600 text-sm">
            ...
            <div className="mt-8 pt-6 border-t border-gray-200">
              <p className="text-sm text-gray-500 text-center">
                ...
                <a href="https://github.com/imsks/rajniti" className="text-orange-600 font-semibold hover:underline">
                  Star us on GitHub
                </a>
              </p>
            </div>
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          <div className="text-center">
            ...
            <p className="text-sm text-gray-500 mt-6">
              © {new Date().getFullYear()} Rajniti. Open source under MIT License.
            </p>
          </div>
        </div>
      </footer>
