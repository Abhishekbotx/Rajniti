...
def test_candidate_get_by_party(setup_database, clean_session):
    ...
    Candidate.create(clean_session, "cand-p-2", "Cand 2", "party-x", "c-2", "S1", "LOST")
...
def test_candidate_bulk_create(setup_database, clean_session):
    ...
    cands_data = [
        {"id": "bulk-cand-1", "name": "Bulk 1", "party_id": "p-1", 
         "constituency_id": "c-1", "state_id": "S1", "status": "WON"},
        {"id": "bulk-cand-2", "name": "Bulk 2", "party_id": "p-2", 
         "constituency_id": "c-2", "state_id": "S1", "status": "LOST"},
    ]
