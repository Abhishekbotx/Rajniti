...
class PoliticalHistory(BaseModel):
    party: str = Field(..., description="Name of the political party")
...
class FamilyMember(BaseModel):
    name: Optional[str] = Field(None, description="Name of the family member")
    profession: Optional[str] = Field(None, description="Profession of the family member")
    relation: str = Field(..., description="Relation to the candidate (e.g., Spouse, Son, Daughter)")
...
class AssetDetails(BaseModel):
    ...
    amount: Optional[float] = Field(None, description="Monetary value of the asset")
...
class LiabilityDetails(BaseModel):
    ...
    amount: Optional[float] = Field(None, description="Monetary value of the liability")
